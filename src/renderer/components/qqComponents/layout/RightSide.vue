...
// @import "~@/assets/assets/styles/variable.less";
.right-side-wrapper {
  position: relative;
    ...
    .tool-wrapper {
      ...
      .tool {
        ...
        .search-word {
          ...
          caret-color: #ffffff;
          color: #ffffff;
          background: url("~@/assets/assets/images/search.png") no-repeat 7px center;
...
.cut {
  background-image: url("~@/assets/assets/images/cut.png");
}
.minium {
  background-image: url("~@/assets/assets/images/minium.png");
}
.maxium {
  background-image: url("~@/assets/assets/images/maxium.png");
}
.close {
  background-image: url("~@/assets/assets/images/close.png");
}
.login {
  background-image: url("~@/assets/assets/images/login.png");
}
